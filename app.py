...
sports = ['Australian Rules Football', 'Baseball', 'Basketball', 'Camogie', 'Cricket', 'American Football', 'Gaelic Football', 'Golf' 'Field Hockey', 'hurling', 'Ice Hockey', 'Lacrosse', 'not a sport','Quidditch', 'Rugby', 'Soccer', 'Tennis']
